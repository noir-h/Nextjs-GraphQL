...
### 5-1.  install modules + init
    ...
    yarn graphql-codegen init
         ...
         ? Where is your schema?: (path or url) graphqlのURL
         ? Where are your operations and fragments?: queries/**/*.ts
         ? Pick plugins: TypeScript (required by other typescript plugins), TypeScript Operations (operations and fragments), TypeScript React Apo
         llo (typed components and HOCs)
